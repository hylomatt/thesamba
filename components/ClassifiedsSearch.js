...
export default function Main({ open, setOpen }) {
  ...
  const searchModels = [
    { value: "All", title: "All" },
    {
      value: "Bug - Split Window - Sedan",
      title: "Bug - Split Window - Sedan",
    },
    {
      value: "Bug - Split Window - Ragtop",
      title: "Bug - Split Window - Ragtop",
    },
    {
      value: "Bug - Split Window - Convertible",
      title: "Bug - Split Window - Convertible",
    },
    { value: "Bug - Oval Window - Sedan", title: "Bug - Oval Window - Sedan" },
    {
      value: "Bug - Oval Window - Ragtop",
      title: "Bug - Oval Window - Ragtop",
    },
    {
      value: "Bug - Oval Window - Convertible",
      title: "Bug - Oval Window - Convertible",
    },
    ...
    {
      value: "Super Beetle - Convertible",
      title: "Super Beetle - Convertible",
    },
    {
      value: "Brazilian Split Bus - All Years",
      title: "Brazilian Split Bus - All Years",
    },
    { value: "1949-67 Bus - Panel", title: "1949-67 Bus - Panel" },
    { value: "1949-67 Bus - Kombi", title: "1949-67 Bus - Kombi" },
    {
      value: "1949-67 Bus - Standard/Microbus",
      title: "1949-67 Bus - Standard/Microbus",
    },
    { value: "1949-67 Bus - Deluxe", title: "1949-67 Bus - Deluxe" },
    { value: "1949-67 Bus - Camper", title: "1949-67 Bus - Camper" },
    {
      value: "1949-67 Bus - Special Model",
      title: "1949-67 Bus - Special Model",
    },
    ...
    {
      value: "1968-79 Bus - Kombi/Standard",
      title: "1968-79 Bus - Kombi/Standard",
    },
    { value: "1968-79 Bus - Deluxe", title: "1968-79 Bus - Deluxe" },
    { value: "1968-79 Bus - Camper", title: "1968-79 Bus - Camper" },
    {
      value: "1968-79 Bus - Special Model",
      title: "1968-79 Bus - Special Model",
    },
    ...
    {
      value: "1980-up Bus - Vanagon - All",
      title: "1980-up Bus - Vanagon - All",
    },
    {
      value: "1991-up Bus - Eurovan - All",
      title: "1991-up Bus - Eurovan - All",
    },
  ...
  const searchStates = [
    ...
    {
      value: "Federated States Miconesia",
      title: "Federated States Miconesia",
    },
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <DialogContentText>
          <strong>Tips:</strong> Use * as a wildcard for partial matches, e.g.
          sema* would find all ads with semaphore.
        </DialogContentText>
        ...
        >
          <TextField
            autoFocus
            margin="dense"
            value={formVals.keywords}
            onChange={(e) =>
              setFormVals({ ...formVals, keywords: e.target.value })
            }
            label="Find"
            type="text"
            fullWidth
          ...
          <Grid container>
            <Grid item xs={6} style={{ paddingRight: "4px" }}>
              <TextField
                ...
                value={formVals.type}
                onChange={(e) =>
                  setFormVals({ ...formVals, type: e.target.value })
                }
                label="Search"
                variant="outlined"
                fullWidth
            ...
            <Grid item xs={6} style={{ paddingLeft: "4px" }}>
              <TextField
                select
                margin="dense"
                value={formVals.stype}
                onChange={(e) =>
                  setFormVals({ ...formVals, stype: e.target.value })
                }
                label="Search Type"
                variant="outlined"
                fullWidth
            ...
            <Grid container>
              <Grid item xs={6} style={{ paddingRight: "4px" }}>
                <TextField
                  select
                  margin="dense"
                  value={formVals.yearfrom}
                  onChange={(e) =>
                    setFormVals({ ...formVals, yearfrom: e.target.value })
                  }
                  label="From"
                  variant="outlined"
                  fullWidth
              ...
              <Grid item xs={6} style={{ paddingLeft: "4px" }}>
                <TextField
                  select
                  margin="dense"
                  value={formVals.yearto}
                  onChange={(e) =>
                    setFormVals({ ...formVals, yearto: e.target.value })
                  }
                  label="To"
                  variant="outlined"
                  fullWidth
          ...
          <FormGroup>
            ...
            <Grid container>
              <Grid item xs={6} style={{ paddingRight: "4px" }}>
                <TextField
                  margin="dense"
                  value={formVals.pricefrom}
                  onChange={(e) =>
                    setFormVals({ ...formVals, pricefrom: e.target.value })
                  }
                  label="From"
                  type="text"
                  fullWidth
              ...
              <Grid item xs={6} style={{ paddingLeft: "4px" }}>
                <TextField
                  margin="dense"
                  value={formVals.priceto}
                  onChange={(e) =>
                    setFormVals({ ...formVals, priceto: e.target.value })
                  }
                  label="To"
                  type="text"
                  fullWidth
          ...
          <TextField
            select
            margin="dense"
            value={formVals.wanted}
            onChange={(e) =>
              setFormVals({ ...formVals, wanted: e.target.value })
            }
            label="Wanted Ads"
            variant="outlined"
            fullWidth
          ...
          <Accordion square={true}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography>Optional Location Criteria</Typography>
            </AccordionSummary>
              ...
              <Box width="100%">
                ...
                <FormGroup>
                  ...
                  <TextField
                    ...
                    value={formVals.zip}
                    onChange={(e) =>
                      setFormVals({ ...formVals, zip: e.target.value })
                    }
                    label="Zip"
                    type="text"
                    variant="outlined"
                  ...
                  <TextField
                    select
                    margin="dense"
                    value={formVals.zipdist}
                    onChange={(e) =>
                      setFormVals({ ...formVals, zipdist: e.target.value })
                    }
                    label="Distance"
                    variant="outlined"
                    defaultValue="0"
                ...
                <br />
                <FormControl margin="dense" variant="outlined" fullWidth>
                  <InputLabel id="search-state-label">
                    State/Province
                  </InputLabel>
                  <Select
                ...
                <TextField
                  select
                  margin="dense"
                  value={formVals.usaregion}
                  onChange={(e) =>
                    setFormVals({ ...formVals, usaregion: e.target.value })
                  }
                  label="Region"
                  variant="outlined"
                  autoComplete="off"
                ...
                >
                  ...
                  <MenuItem value="Partial Gulf Coast">
                    Partial Gulf Coast
                  </MenuItem>
                ...
                <TextField
                  ...
                  onChange={(e) =>
                    setFormVals({ ...formVals, country: e.target.value })
                  }
                  label="Country"
                  variant="outlined"
                  autoComplete="off"
                ...
                >
                  ...
                  <MenuItem value="Azerbaijan Republic">
                    Azerbaijan Republic
                  </MenuItem>
                  ...
                  <MenuItem value="Canada">Canada</MenuItem>
                  <MenuItem value="Cape Verde Islands">
                    Cape Verde Islands
                  </MenuItem>
                  ...
                  <MenuItem value="Congo, Democratic Republic of the">
                    Congo, Democratic Republic of the
                  </MenuItem>
                  <MenuItem value="Congo, Republic of the">
                    Congo, Republic of the
                  </MenuItem>
                  <MenuItem value="Cook Islands">Cook Islands</MenuItem>
                  <MenuItem value="Costa Rica">Costa Rica</MenuItem>
                  <MenuItem value="Cote d Ivoire (Ivory Coast)">
                    Cote d Ivoire (Ivory Coast)
                  </MenuItem>
                  <MenuItem value="Croatia, Republic of">
                    Croatia, Republic of
                  </MenuItem>
                  ...
                  <MenuItem value="Falkland Islands (Islas Malvinas)">
                  ...
                  <MenuItem value="Kenya Coast Republic">
                  ...
                  <MenuItem value="Saint Kitts-Nevis">
                    Saint Kitts-Nevis
                  </MenuItem>
                ...
                <TextField
                  ...
                  value={formVals.sort}
                  onChange={(e) =>
                    setFormVals({ ...formVals, sort: e.target.value })
                  }
                  label="Sort By"
                  variant="outlined"
                  autoComplete="off"
                ...
                <TextField
                  select
                  margin="dense"
                  value={formVals.sort_order}
                  onChange={(e) =>
                    setFormVals({ ...formVals, sort_order: e.target.value })
                  }
                  label="Sort Order"
                  variant="outlined"
                  autoComplete="off"
